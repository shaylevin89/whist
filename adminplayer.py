...
class GameBoard:
    def __init__(self):
        ...
        self.player2 = Label(self.root, text='player 3', padx=200, pady=30, font=('arial', 18)).pack()
        self.name_label = Label(self.root, text='Admin player', padx=50, pady=30, font=('arial', 18), bg='green')
        self.name_label.place(relx=0.4, rely=0.905)
        self.canvas = Canvas(width=80, height=340)
        self.canvas.create_text(40, 180, font=('arial', 18), text="player 2", angle=90)
        self.canvas.place(relx=0, rely=0.2)
        self.canvas2 = Canvas(width=80, height=340)
        self.canvas2.create_text(40, 180, font=('arial', 18), text="player 4", angle=270)
        ...
        self.cleanbtn1 = Button(self.root, text='cl 1', command=lambda: self.clean_table('1'))
        self.cleanbtn1.place(relx=0.9, rely=0.9)
        self.cleanbtn2 = Button(self.root, text='cl 2', command=lambda: self.clean_table('2'))
        self.cleanbtn2.place(relx=0.86, rely=0.85)
        self.cleanbtn3 = Button(self.root, text='cl 3', command=lambda: self.clean_table('3'))
        self.cleanbtn3.place(relx=0.9, rely=0.8)
        self.cleanbtn4 = Button(self.root, text='cl 4', command=lambda: self.clean_table('4'))
        self.cleanbtn4.place(relx=0.94, rely=0.85)
        self.thr = Thread(target=self.first_connect)
        self.thr.start()
        self.root.mainloop()

    def clean_table(self, player):
        # add sign for the player to send everyone and change elif == 5
