...
class GameBoard:
    def __init__(self):
        ...
        self.dbtn = Button(self.root, text=self.suits[0], command=lambda: self.send_sign('0'))
        self.dbtn.place(relx=0.9, rely=0.95)
        self.cbtn = Button(self.root, text=self.suits[1], command=lambda: self.send_sign('1'))
        self.cbtn.place(relx=0.88, rely=0.95)
        self.hbtn = Button(self.root, text=self.suits[2], command=lambda: self.send_sign('2'))
        self.hbtn.place(relx=0.86, rely=0.95)
        self.sbtn = Button(self.root, text=self.suits[3], command=lambda: self.send_sign('3'))
        self.sbtn.place(relx=0.84, rely=0.95)
